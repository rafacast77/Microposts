...
_ui.uI.postBtn_EL.addEventListener('click', submitPost);

// Delete a post EventListener
_ui.uI.posts_EL.addEventListener('click', deletePost);

// Change Update-State EventListener
_ui.uI.posts_EL.addEventListener('click', updateState);

// Cancel Update-State EventListener
_ui.uI.formPost_EL.addEventListener('click', cancelUpdateState);
...
function getPosts() {
  _http.http.getPosts('http://localhost:3000/posts').then(function (data) {
...
function submitPost(e) {
  var tittle = _ui.uI.postTittle_EL.value,
      body = _ui.uI.postBody_EL.value,
      id = _ui.uI.idSpan_EL.value;
  ...
  // Validate input
  if (tittle === '' || body === '') {
    _ui.uI.showAlert('All inputs must be filled', 'alert-danger');
  } else {

    // Adds a Post
    if (e.target.textContent === 'Post') {
      _http.http.post('http://localhost:3000/posts', data).then(function (data) {
        _ui.uI.showAlert('New Post Added', 'alert-success');
        _ui.uI.clearInputs();
        getPosts();
      }).catch(function (err) {
        return console.log(err);
      ...
      _http.http.updatePost('http://localhost:3000/posts/' + id, data).then(function (data) {
        _ui.uI.showAlert('Post Updated', 'alert-success');
        _ui.uI.clearInputs();
        _ui.uI.changeAddState();
        getPosts();
      }).catch(function (err) {
        return console.log(err);
      });
...
function deletePost(e) {
  if (e.target.parentElement.classList.contains('delete')) {
    ...
    _http.http.deletePost('http://localhost:3000/posts/' + id);
    _ui.uI.showAlert('Post deleted', 'alert-success');
    getPosts();
  }
  e.preventDefault();
}
...
function updateState(e) {
  if (e.target.parentElement.classList.contains('update')) {
    var body = e.target.parentElement.previousElementSibling.innerText,
        tittle = e.target.parentElement.previousElementSibling.previousElementSibling.innerText,
...
////////////////////////////////////////////////////////////////////////////////
var PostsHTTP = function () {
  function PostsHTTP() {
    _classCallCheck(this, PostsHTTP);
  }

  _createClass(PostsHTTP, [{
    key: 'getPosts',
    ...
    key: 'deletePost',
    value: function () {
      var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(url, id) {
        var response, resData;
...
var http = exports.http = new PostsHTTP();
...
var UI = function () {
  ...
  _createClass(UI, [{
    key: 'showPosts',
    value: function showPosts(postData) {
      var output = '';
    ...
    value: function changeUpdateState(data) {
